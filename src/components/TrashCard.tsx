...
const TrashCard = (props: Props) => {
  ...
  useEffect(() => {
    ...
    if (showOptions || showConfirmation) {
        ...
        showConfirmation && (
          <div className='absolute top-0 left-0 w-full h-full bg-neutral-800/20 z-50'>
            <div className='flex flex-col justify-center h-full'>
              <div className='bg-white max-w-4xl mx-auto rounded' ref={confirmationRef}>
                <div className="flex flex-col px-9 py-9 space-y-10">
                  ...
                  <div className='flex flex-col space-y-2'>
                    ...
                    <button className='bg-accent text-white font-medium px-4 py-2 rounded hover:bg-blue-700' onClick={() => setShowConfirmation(false)}>Não! Me leve de volta</button>
